...
export default class SecurityStock extends Component {
  ...
  updateInputValueEnero(evt) {
    ...
    this.setState({
      ssEnero: parseInt(evt.target.value)
    });
  }
  ...
  updateInputValueFebrero(evt) {
    ...
    this.setState({
      ssFebrero: parseInt(evt.target.value)
    });
  }
  ...
  updateInputValueMarzo(evt) {
    ...
    this.setState({
      ssMarzo: parseInt(evt.target.value)
    });
  }
  ...
  updateInputValueAbril(evt) {
    ...
    this.setState({
      ssAbril: parseInt(evt.target.value)
    });
  }
  ...
  updateInputValueMayo(evt) {
    ...
    this.setState({
      ssMayo: parseInt(evt.target.value)
    });
  }
  ...
  updateInputValueJunio(evt) {
    ...
    this.setState({
      ssJunio: parseInt(evt.target.value)
    });
  }
