  ...
  render() {
    return (
      ...
      <div>
        ...
        <span>Abril
        <input id="ssAbril" value={this.state.ssAbril} onChange={evt => this.updateInputValueAbril(evt)} type="range" list="tickmarks" step="5" min="0" max="100" className="form-control"/>
        </span>
